...
* **Principle of Least Privilege**: The Cloud Run runtime identity holds only `roles/bigquery.dataViewer`, `roles/bigquery.jobUser`, and `roles/secretmanager.secretAccessor`.
